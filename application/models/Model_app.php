...
class Model_app extends CI_Model {
    ...
    private function complexQueries ( $where = false, $fields = false, $table = false, $join = false, $orderBy = false, $groupBy = false, $limit = false, $compiledQuery=false ) {
    ...
    function get_compiled_query(...$args ){
        $query = call_user_func_array( array( $this, 'complexQueries'), $args );
        return $query;
    }
